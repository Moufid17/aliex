 ...
 */
final class Version20220710164418 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Init tables : adress, catregory, product, user';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, category_id INT DEFAULT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, weight DOUBLE PRECISION NOT NULL, description TEXT NOT NULL, price DOUBLE PRECISION NOT NULL, image_name VARCHAR(255) NOT NULL, image_size INT NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
